...
import AircraftDropdownActions from "@/components/dropdowns/AircraftDropdownActions";
...
export const columns: ColumnDef<Aircraft>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="flex justify-center">
        <span className="text-muted-foreground italic">{row.original.acronym}</span>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader filter column={column} title="Fecha de Fabricación" />
    ),
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader filter column={column} title="Operadora de Aviones" />
    ),
